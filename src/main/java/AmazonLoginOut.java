...
public class AmazonLoginOut {
    public static void main(String[] args) {
        ...
        driver.findElement(By.xpath("//input[@id='ap_email']")).sendKeys("patelpooja6411@yahoo.com");
        ...
        driver.findElement(By.xpath("//input[@id='ap_phone_number']")).sendKeys("9898984745");
